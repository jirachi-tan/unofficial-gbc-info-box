...
export const stampTourSpots: StampTourSpot[] = [
    ...
    {
        id: "tokaido-kawasaki-shuku-koryukan",
        lineupNo: 24,
        name: "東海道かわさき宿交流館",
        character: "井芹仁菜",
        spotType: "facility",
        address: "〒210-0001 神奈川県川崎市川崎区本町1丁目8番地4",
        stampPlace: "東海道かわさき宿交流館1F受付",
        badgeSalePlace: "東海道かわさき宿交流館1F受付",
        businessHours: "9:00〜17:00（物販コーナーは16:30まで）",
        regularHoliday: "月曜日 / 12月29日〜1月3日（月曜が祝日の場合は翌平日）",
        notes: ["入館無料。"],
        officialUrl: "https://kawasakishuku.jp/",
        officialLinks: [
            { label: "施設HP", url: "https://kawasakishuku.jp/" },
            { label: "公式Instagram", url: "https://www.instagram.com/tokaido_kawasaki_shuku_koryu/" },
        ],
        mapQuery: "東海道かわさき宿交流館",
        sourceUrl: STAMP_TOUR_OFFICIAL_SPOT_URL,
    },
    {
        id: "karyo-tohteru-honten",
        lineupNo: 25,
        name: "菓寮東照 本店",
        character: "安和すばる",
        spotType: "store",
        address: "〒210-0001 神奈川県川崎市川崎区本町1-8-9",
        stampPlace: "菓寮東照 本店",
        badgeSalePlace: "菓寮東照 本店",
        businessHours: "9:00〜18:00",
        regularHoliday: "毎週木曜日 / 8月と年始に数日",
        notes: ["営業日・定休日の詳細はHP・SNSをご確認ください。"],
        officialUrl: "https://www.tohteru.com/",
        officialLinks: [
            { label: "店舗HP", url: "https://www.tohteru.com/" },
            { label: "公式Instagram", url: "https://www.instagram.com/tohteru/" },
        ],
        mapQuery: "菓寮東照 本店",
        sourceUrl: STAMP_TOUR_OFFICIAL_SPOT_URL,
    },
